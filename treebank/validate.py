    ...
    for conllu_file_path in conllu_file_paths:
        ...
        try:
            with open(conllu_file_path, encoding="utf-8") as conllu_file:
                assert TreeBank.from_conllu_file(conllu_file_path).to_conllu() == conllu_file.read().rstrip("\n\n"), f"{TreeBank.__name__} class failed to losslessly encode {conllu_file_path}\nPlease report this bug."
            print("Passed")
